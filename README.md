...
The release artifact is `build/libs/voris-hub-1.10.63.jar`. `verifyRelease` runs unit tests and checks final JAR metadata, required classes, and Java 8 bytecode.
