...
public class AutoMinerTest {
    ...
    public void miningWorkAreaRequiresClearPlayerCellsAndSolidSupport() {
        ...
        assertTrue(AutoMiner.routeSupportSafe(true, false));
        assertFalse(AutoMiner.routeSupportSafe(true, true));
        assertFalse(AutoMiner.routeSupportSafe(false, false));
    ...
    public void stalePathSnapshotsRefreshAfterEightFailedCandidates() {
        ...
        assertFalse(AutoMiner.reusePathCandidateSnapshot(
            java.util.Collections.emptyList(), feet, feet));
    ...
    public void completionConfirmationKeepsTheDeadlineTick() {
        ...
        assertTrue(AutoMiner.routeBlockerOwnership(true, true, false));
        assertFalse(AutoMiner.routeBlockerOwnership(false, true, false));
